...
public class StudentDatabase {
    ...
    public static List<Student> getAllStudents() {
        ...
        Student student2 = new Student("Jenny",2,3.8,"female",
                Arrays.asList("swimming", "gymnastics","soccer"), 24);

        Student student3 = new Student("Emily",3,4.0,"female",
                Arrays.asList("swimming", "gymnastics","aerobics"), 14);
        Student student4 = new Student("Dave",3,4.0,"male",
                Arrays.asList("swimming", "gymnastics","soccer"), 0);

        Student student5 = new Student("Sophia",4,3.5,"female",
                Arrays.asList("swimming", "dancing","football"), 81);
        Student student6 = new Student("James",4,3.9,"male",
                Arrays.asList("swimming", "basketball","baseball","football"), 6);
